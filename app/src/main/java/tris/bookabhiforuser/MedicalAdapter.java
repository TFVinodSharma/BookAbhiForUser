...
public class MedicalAdapter extends RecyclerView.Adapter<MedicalAdapter.Versionview> {
    ...
    public MedicalAdapter(String[]data1,String[]data2,String[]data3,String[]data4,String[]data5,String[]data6){
        this.data1=data1;
        this.data2=data2;
        this.data3=data3;
        this.data4=data4;
    ...
    public Versionview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.new_medical,parent,false);
    ...
    public class Versionview extends RecyclerView.ViewHolder{
        ...
        public Versionview(View itemView) {
            super(itemView);
            tv=itemView.findViewById(R.id.medicalName);
            tv1=itemView.findViewById(R.id.medicalRank);
            tv2=itemView.findViewById(R.id.medicalWork);
            tv3=itemView.findViewById(R.id.medcalRating);
            tv4=itemView.findViewById(R.id.medcalReview);
            tv5=itemView.findViewById(R.id.medicalFee);
